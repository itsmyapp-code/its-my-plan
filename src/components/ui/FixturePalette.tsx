                ...
                <div className="mt-1 space-y-0.5 pl-2">
                  {items.map((item) => (
                    <button
                      ...
                      className="w-full flex items-center gap-2 px-2 py-2 rounded-lg text-left text-xs text-slate-700 hover:bg-slate-100 hover:text-slate-900 transition-colors group"
                    >
                      <div
