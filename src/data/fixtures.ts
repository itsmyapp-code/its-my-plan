...
export const FIXTURE_LIBRARY: FixtureDefinition[] = [
  ...
  },
  {
    ...
    depth: 86,
    color: '#f97316',
    clearance: { front: 0, sides: 0, description: 'Wall-mounted TV aerial/satellite point' },
  },
  {
    id: 'uk-elec-cat6',
    label: 'Data Point (CAT6)',
    category: 'electrical',
    iconType: 'electric',
    width: 86,
    depth: 86,
    color: '#f97316',
    clearance: { front: 0, sides: 0, description: 'Wall-mounted data point' },
  },
  {
    id: 'uk-elec-smoke-detector',
    ...
    depth: 100,
    color: '#f97316',
    clearance: { front: 0, sides: 0, description: 'Ceiling-mounted smoke alarm' },
  },
  {
    id: 'uk-elec-heat-detector',
    label: 'Heat Detector',
    category: 'electrical',
    iconType: 'electric',
    width: 100,
    depth: 100,
    color: '#f97316',
    clearance: { front: 0, sides: 0, description: 'Ceiling-mounted heat alarm' },
  },
  {
    id: 'uk-elec-call-point',
    ...
    depth: 86,
    color: '#f97316',
    clearance: { front: 0, sides: 0, description: 'Wall-mounted fire alarm call point' },
  },
  {
    id: 'uk-elec-fcu',
    label: 'Fused Connection Unit',
    category: 'electrical',
    iconType: 'electric',
    width: 86,
    depth: 86,
    color: '#f97316',
    clearance: { front: 0, sides: 0, description: 'Wall-mounted fused spur' },
  },
  {
    id: 'uk-elec-consumer-unit',
    label: 'Consumer Unit',
    category: 'electrical',
    iconType: 'electric',
    width: 250,
    depth: 100,
    color: '#f97316',
    clearance: { front: 0, sides: 0, description: 'Wall-mounted distribution board' },
  },
